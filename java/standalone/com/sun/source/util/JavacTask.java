...
public abstract class JavacTask implements CompilationTask {
    ...
    public static JavacTask instance(ProcessingEnvironment processingEnvironment) {
        if (!processingEnvironment.getClass().getName().equals(
                "standalone.com.sun.tools.javac.processing.JavacProcessingEnvironment"))
     ...
     * {@link standalone.com.sun.source.util.Trees Trees}.
     *
     * @param path the path
     * @return the type mirror
     * @see standalone.com.sun.source.util.Trees#getTypeMirror
     */
