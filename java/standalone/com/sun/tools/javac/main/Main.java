...
import standalone.com.sun.tools.javac.api.BasicJavacTask;
import standalone.com.sun.tools.javac.file.CacheFSInfo;
...
import standalone.com.sun.tools.javac.processing.AnnotationProcessingError;
import standalone.com.sun.tools.javac.resources.CompilerProperties.Errors;
import standalone.com.sun.tools.javac.util.*;
import standalone.com.sun.tools.javac.util.JCDiagnostic.DiagnosticInfo;
import standalone.com.sun.tools.javac.util.Log.PrefixKind;
import standalone.com.sun.tools.javac.util.Log.WriterKind;

import standalone.jdk.internal.opt.CommandLine;
import standalone.jdk.internal.opt.CommandLine.UnmatchedQuote;
...
public class Main {
    ...
    public Result compile(String[] argv, Context context) {
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "standalone.com.sun.tools.javac.Main";
            showClass(showClass);
        }
    ...
    public static final String javacBundleName =
        "standalone.com.sun.tools.javac.resources.javac";
}
