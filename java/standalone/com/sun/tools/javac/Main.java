...
package standalone.com.sun.tools.javac;
...
public class Main {
    ...
    public static int compile(String[] args) {
        standalone.com.sun.tools.javac.main.Main compiler =
            new standalone.com.sun.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        standalone.com.sun.tools.javac.main.Main compiler =
            new standalone.com.sun.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
