...
package standalone.com.sun.tools.javac.launcher;
...
import standalone.com.sun.tools.javac.resources.LauncherProperties.Errors;
...
public class Main {
    ...
    private List<String> getJavacOpts(String... runtimeArgs) throws Fault {
        ...
        String sourceOpt = System.getProperty("standalone.jdk.internal.javac.source");
        if (sourceOpt != null) {
    ...
    private static final String bundleName = "standalone.com.sun.tools.javac.resources.launcher";
