...
import standalone.com.sun.tools.javac.main.OptionHelper;
...
public abstract class BaseFileManager implements JavaFileManager {
    ...
    public ByteBuffer makeByteBuffer(InputStream in) throws IOException {
        ...
        standalone.com.sun.tools.javac.util.ByteBuffer buf = new standalone.com.sun.tools.javac.util.ByteBuffer(array);
        buf.appendStream(in);
