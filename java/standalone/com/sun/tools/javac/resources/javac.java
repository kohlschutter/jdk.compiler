...
public final class javac extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "javac.opt.Xlint.desc.output-file-clash", "Warn when an output file is overwritten during compilation. This can occur, for example,\n                         on case-insensitive filesystems. Covers class files, native header files, and source files." },
            ...
            { "javac.opt.Xlint.desc.this-escape", "Warn when a constructor invokes a method that could be overriden in an external subclass.\n                         Such a method would execute before the subclass constructor completes its initialization." },
            ...
            { "javac.opt.addExports", "Specify a package to be considered as exported from its\ndefining module to additional modules, or to all unnamed modules\nif <other-module> is ALL-UNNAMED." },
            { "javac.opt.addReads", "Specify additional modules to be considered as required by\na given module; <other-module> may be ALL-UNNAMED to require\nthe unnamed module." },
            { "javac.opt.addmods", "Root modules to resolve in addition to the initial modules,\nor all modules on the module path if <module> is ALL-MODULE-PATH." },
            ...
            { "javac.opt.default.module.for.created.files", "Fallback target module for files created by annotation processors,\nif none specified or inferred." },
            ...
            { "javac.opt.implicit", "Specify whether to generate class files for implicitly referenced files" },
            ...
            { "javac.opt.prefer", "Specify which file to read when both a source file and class file\nare found for an implicitly compiled class" },
            { "javac.opt.preview", "Enable preview language features.\nTo be used in conjunction with either -source or --release." },
            { "javac.opt.print", "Print out a textual representation of specified types" },
            { "javac.opt.printProcessorInfo", "Print information about which annotations a processor\nis asked to process" },
            ...
            { "javac.opt.processor", "Names of the annotation processors to run;\nbypasses default discovery process" },
            ...
            { "javac.opt.release", "Compile for the specified Java SE release.\nSupported releases: \n    {0}" },
            { "javac.opt.s", "Emit java sources instead of classfiles" },
            { "javac.opt.source", "Provide source compatibility with the specified Java SE release.\nSupported releases: \n    {0}" },
            ...
            { "javac.opt.target", "Generate class files suitable for the specified Java SE release.\nSupported releases: \n    {0}" },
