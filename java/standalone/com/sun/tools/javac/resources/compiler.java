...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compiler.err.annotation.decl.not.allowed.here", "annotation interface declaration not allowed here" },
            ...
            { "compiler.err.annotation.missing.element.value", "annotation is missing element value" },
            { "compiler.err.annotation.not.valid.for.type", "annotation not valid for an element of type {0}" },
            { "compiler.err.annotation.type.not.applicable", "annotation interface not applicable to this kind of declaration" },
            { "compiler.err.annotation.type.not.applicable.to.type", "annotation @{0} not applicable in this type context" },
            { "compiler.err.annotation.unrecognized.attribute.name", "annotation @{0} has an unknown attribute named ''{1}''" },
            ...
            { "compiler.err.bad.file.name", "bad file name: {0}" },
            ...
            { "compiler.err.cannot.assign.not.declared.guard", "cannot assign to {0}, as it was not declared inside the guard" },
            ...
            { "compiler.err.cant.apply.symbol.noargs", "{0} {1} in {2} {3} cannot be applied to given types;\nreason: {4}" },
            { "compiler.err.cant.apply.symbols", "no suitable {0} found for {1}({2})" },
            { "compiler.err.cant.assign.val.to.this", "cannot assign to ''this''" },
            { "compiler.err.cant.assign.val.to.var", "cannot assign a value to {0} variable {1}" },
            ...
            { "compiler.err.constant.label.not.compatible", "constant label of type {0} is not compatible with switch selector type {1}" },
            ...
            { "compiler.err.dc.invalid.html", "invalid HTML" },
            ...
            { "compiler.err.dc.no.title", "no title" },
            { "compiler.err.dc.no.url", "no URL" },
            { "compiler.err.dc.ref.annotations.not.allowed", "annotations not allowed" },
            { "compiler.err.dc.ref.bad.parens", "unexpected text after parenthesis" },
            ...
            { "compiler.err.deconstruction.pattern.only.records", "deconstruction patterns can only be applied to records, {0} is not a record" },
            { "compiler.err.deconstruction.pattern.var.not.allowed", "deconstruction patterns can only be applied to records, var is not allowed" },
            { "compiler.err.default.allowed.in.intf.annotation.member", "default value only allowed in an annotation interface declaration" },
            { "compiler.err.default.label.not.allowed", "default label not allowed here" },
            ...
            { "compiler.err.duplicate.annotation.missing.container", "{0} is not a repeatable annotation interface" },
            ...
            { "compiler.err.duplicate.unconditional.pattern", "duplicate unconditional pattern" },
            ...
            { "compiler.err.enclosing.class.type.non.denotable", "enclosing class type: {0}\nis non-denotable, try casting to a denotable type" },
            ...
            { "compiler.err.enum.cant.be.generic", "enums cannot be generic" },
            { "compiler.err.enum.cant.be.instantiated", "enum classes may not be instantiated" },
            ...
            { "compiler.err.enum.label.must.be.enum.constant", "an enum switch constant case label must be an enumeration constant" },
            ...
            { "compiler.err.enum.types.not.extensible", "enum classes are not extensible" },
            ...
            { "compiler.err.extraneous.semicolon", "extraneous semicolon" },
            ...
            { "compiler.err.flows.through.from.pattern", "illegal fall-through from a pattern" },
            { "compiler.err.flows.through.to.pattern", "illegal fall-through to a pattern" },
            ...
            { "compiler.err.guard.has.constant.expression.false", "this case label has a guard that is a constant expression with value ''false''" },
            { "compiler.err.guard.not.allowed", "guards are only allowed for case with a pattern" },
            ...
            { "compiler.err.incompatible.diff.ret.same.type", "type {0} defines {1}({2}) more than once with unrelated return types" },
            ...
            { "compiler.err.incorrect.number.of.nested.patterns", "incorrect number of nested patterns\nrequired: {0}\nfound: {1}" },
            ...
            { "compiler.err.intf.annotation.cant.have.type.params", "annotation interface {0} cannot be generic" },
            { "compiler.err.intf.annotation.member.clash", "annotation interface {1} declares an element with the same name as method {0}" },
            { "compiler.err.intf.annotation.members.cant.have.params", "elements in annotation interface declarations cannot declare formal parameters" },
            { "compiler.err.intf.annotation.members.cant.have.type.params", "elements in annotation interface declarations cannot be generic methods" },
            ...
            { "compiler.err.invalid.annotation.member.type", "invalid type for annotation interface element" },
            ...
            { "compiler.err.invalid.case.label.combination", "invalid case label combination" },
            ...
            { "compiler.err.invalid.repeatable.annotation.elem.nondefault", "containing annotation interface ({0}) does not have a default value for element {1}" },
            { "compiler.err.invalid.repeatable.annotation.incompatible.target", "containing annotation interface ({0}) is applicable to more targets than repeatable annotation interface ({1})" },
            ...
            { "compiler.err.invalid.repeatable.annotation.not.documented", "repeatable annotation interface ({1}) is @Documented while containing annotation interface ({0}) is not" },
            { "compiler.err.invalid.repeatable.annotation.not.inherited", "repeatable annotation interface ({1}) is @Inherited while containing annotation interface ({0}) is not" },
            ...
            { "compiler.err.invalid.repeatable.annotation.retention", "retention of containing annotation interface ({0}) is shorter than the retention of repeatable annotation interface ({2})" },
            { "compiler.err.invalid.repeatable.annotation.value.return", "containing annotation interface ({0}) must declare an element named ''value'' of type {2}" },
            ...
            { "compiler.err.local.enum", "enum classes must not be local" },
            ...
            { "compiler.err.no.java.lang", "Unable to find package java.lang in platform classes" },
            ...
            { "compiler.err.not.a.processor.type", "not a processor type: {0}" },
            { "compiler.err.not.annotation.type", "{0} is not an annotation interface" },
            ...
            { "compiler.err.not.exhaustive.statement", "the switch statement does not cover all possible input values" },
            ...
            { "compiler.err.pattern.dominated", "this case label is dominated by a preceding case label" },
            { "compiler.err.pattern.expected", "type pattern expected" },
            { "compiler.err.pattern.or.enum.req", "pattern or enum constant required" },
            { "compiler.err.pattern.type.cannot.infer", "cannot infer pattern type" },
            ...
            { "compiler.err.processor.missing.from.string.template.expression", "processor missing from string template expression" },
            { "compiler.err.processor.type.cannot.be.a.raw.type", "processor type cannot be a raw type: {0}" },
            ...
            { "compiler.err.record.patterns.annotations.not.allowed", "annotations not allowed on record patterns" },
            ...
            { "compiler.err.string.template.is.not.well.formed", "string template is not well formed" },
            ...
            { "compiler.err.text.block.template.is.not.well.formed", "text block template is not well formed" },
            ...
            { "compiler.err.unconditional.pattern.and.default", "switch has both an unconditional pattern and a default label" },
            ...
            { "compiler.err.unnamed.class.does.not.have.main.method", "unnamed class does not have main method in the form of void main() or void main(String[] args)" },
            { "compiler.err.unnamed.class.should.not.have.package.declaration", "unnamed class should not have package declaration" },
            ...
            { "compiler.err.use.of.underscore.not.allowed", "as of release 21, the underscore keyword ''_'' is only allowed to declare\nunnamed patterns, local variables, exception parameters or lambda parameters" },
            { "compiler.err.use.of.underscore.not.allowed.with.brackets", "the underscore keyword ''_'' is not allowed to be followed by brackets" },
            ...
            { "compiler.misc.bad.class.truncated.at.offset", "class file truncated at offset {0}" },
            ...
            { "compiler.misc.bad.utf8.byte.sequence.at", "bad UTF-8 byte sequence at {0}" },
            ...
            { "compiler.misc.cant.apply.array.ctor", "cannot create array from given types\nrequired: {0}\nfound:    {1}\nreason:   {2}" },
            ...
            { "compiler.misc.feature.deconstruction.patterns", "deconstruction patterns" },
            ...
            { "compiler.misc.feature.pattern.switch", "patterns in switch statements" },
            ...
            { "compiler.misc.feature.string.templates", "string templates" },
            ...
            { "compiler.misc.feature.unconditional.patterns.in.instanceof", "unconditional patterns in instanceof" },
            { "compiler.misc.feature.unnamed.classes", "unnamed classes" },
            { "compiler.misc.feature.unnamed.variables", "unnamed variables" },
            ...
            { "compiler.misc.guard", "a guard" },
            { "compiler.misc.illegal.flag.combo", "class file contains illegal flag combination {0} for {1} {2}" },
            ...
            { "compiler.misc.not.applicable.types", "pattern of type {1} is not applicable at {0}" },
            ...
            { "compiler.misc.upper.bounds", "upper bounds: {0}" },
            ...
            { "compiler.note.implicit.annotation.processing", "Annotation processing is enabled because one or more processors were found\non the class path. A future release of javac may disable annotation processing\nunless at least one processor is specified by name (-processor), or a search\npath is specified (--processor-path, --processor-module-path), or annotation\nprocessing is enabled explicitly (-proc:only, -proc:full).\nUse -Xlint:-options to suppress this message.\nUse -proc:none to disable annotation processing." },
            ...
            { "compiler.warn.OSF.array.SPF", "serialPersistentFields must be of type java.io.ObjectStreamField[] to be effective" },
            ...
            { "compiler.warn.default.ineffective", "serialization-related default method from an interface will not be run by serialization for an implementing class" },
            ...
            { "compiler.warn.externalizable.missing.public.no.arg.ctor", "an Externalizable class needs a public no-arg constructor" },
            { "compiler.warn.extraneous.semicolon", "extraneous semicolon" },
            ...
            { "compiler.warn.improper.SPF", "serialPersistentFields must be declared private static final to be effective" },
            ...
            { "compiler.warn.ineffectual.serial.field.enum", "serialization-related field {0} is not effective in an enum class" },
            { "compiler.warn.ineffectual.serial.field.externalizable", "serialPersistentFields is not effective in an Externalizable class" },
            { "compiler.warn.ineffectual.serial.field.interface", "serialPersistentFields is not effective in an interface" },
            { "compiler.warn.ineffectual.serial.field.record", "serialPersistentFields is not effective in a record class" },
            { "compiler.warn.ineffectual.serial.method.enum", "serialization-related method {0} is not effective in an enum class" },
            { "compiler.warn.ineffectual.serial.method.externalizable", "serialization-related method {0} is not effective in an Externalizable class" },
            { "compiler.warn.ineffectual.serial.method.record", "serialization-related method {0} is not effective in a record class" },
            ...
            { "compiler.warn.invalid.utf8.in.classfile", "{0}: classfile contains invalid UTF-8: {1}" },
            ...
            { "compiler.warn.non.serializable.instance.field", "non-transient instance field of a serializable class declared with a non-serializable type" },
            { "compiler.warn.non.serializable.instance.field.array", "non-transient instance field of a serializable class declared with an array having a non-serializable base component type {0}" },
            ...
            { "compiler.warn.output.file.clash", "output file written more than once: {0}" },
            ...
            { "compiler.warn.possible.loss.of.precision", "implicit cast from {0} to {1} in compound assignment is possibly lossy" },
            { "compiler.warn.possible.this.escape", "possible ''this'' escape before subclass is fully initialized" },
            { "compiler.warn.possible.this.escape.location", "previous possible ''this'' escape happens here via invocation" },
            ...
            { "compiler.warn.proc.duplicate.supported.annotation", "Duplicate supported annotation interface ''{0}'' returned by annotation processor ''{1}''" },
            ...
            { "compiler.warn.proc.malformed.supported.string", "Malformed string ''{0}'' for a supported annotation interface returned by processor ''{1}''" },
            ...
            { "compiler.warn.proc.redundant.types.with.wildcard", "Annotation processor ''{0}'' redundantly supports both ''*'' and other annotation interfaces" },
            ...
            { "compiler.warn.serial.concrete.instance.method", "serialization-related method {0} must be a concrete instance method to be effective, neither abstract nor static" },
            { "compiler.warn.serial.method.no.args", "to be effective serialization-related method {0} must have no parameters" },
            { "compiler.warn.serial.method.not.private", "serialization-related method {0} not declared private" },
            { "compiler.warn.serial.method.one.arg", "to be effective serialization-related method {0} must have exactly one parameter rather than {1} parameters" },
            { "compiler.warn.serial.method.parameter.type", "sole parameter of serialization-related method {0} must have type {1} to be effective rather than type {2}" },
            { "compiler.warn.serial.method.static", "serialization-related method {0} declared static; must instead be an instance method to be effective" },
            { "compiler.warn.serial.method.unexpected.exception", "serialization-related method {0} declared to throw an unexpected type {1}" },
            ...
            { "compiler.warn.serializable.missing.access.no.arg.ctor", "cannot access a no-arg constructor in first non-serializable superclass {0}" },
            ...
            { "compiler.warn.static.not.qualified.by.type2", "static {0} should not be used as a member of an anonymous class" },
            { "compiler.warn.strictfp", "as of release 17, all floating-point expressions are evaluated strictly and ''strictfp'' is not required" },
