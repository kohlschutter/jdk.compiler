...
import standalone.com.sun.tools.javac.code.Type.ForAll;
import standalone.com.sun.tools.javac.code.Type.MethodType;
import standalone.com.sun.tools.javac.code.Type.PackageType;
import standalone.com.sun.tools.javac.code.Type.TypeVar;
import standalone.com.sun.tools.javac.code.Type.UndetVar;
import standalone.com.sun.tools.javac.code.Type.Visitor;
...
import standalone.com.sun.tools.javac.code.Type.ModuleType;
import standalone.com.sun.tools.javac.comp.Annotate;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link standalone.com.sun.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
                ...
                final TypeAnnotationPosition pos)
        {
            ...
            if (type.hasTag(TypeTag.TYPEVAR)) {
                ...
                // UnionClassType uct = (standalone.com.sun.tools.javac.code.Type.UnionClassType)type;
                         ...
                         ListBuffer<TypePathEntry> location)
        {
            ...
            // standalone.com.sun.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
        ...
        public void visitClassDef(JCClassDecl tree) {
            ...
            if (tree.sym.isRecord()) {
                tree.sym.getRecordComponentsStandalone().forEach(rc -> scan(rc.accessorMeth));
            }
        }
