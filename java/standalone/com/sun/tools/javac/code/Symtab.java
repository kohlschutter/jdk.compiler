...
import standalone.com.sun.tools.javac.code.Symbol.RootPackageSymbol;
import standalone.com.sun.tools.javac.code.Symbol.TypeSymbol;
import standalone.com.sun.tools.javac.code.Symbol.VarSymbol;
import standalone.com.sun.tools.javac.code.Type.BottomType;
...
import standalone.com.sun.tools.javac.code.Type.JCVoidType;
import standalone.com.sun.tools.javac.code.Type.MethodType;
import standalone.com.sun.tools.javac.code.Type.UnknownType;
import standalone.com.sun.tools.javac.code.Types.UniqueType;
...
import standalone.com.sun.tools.javac.util.JavacMessages;
...
public class Symtab {
    ...
    protected Symtab(Context context) throws CompletionFailure {
        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    standalone.com.sun.tools.javac.code.Directive.RequiresDirective d =
                            new standalone.com.sun.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(standalone.com.sun.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
        ...
        previewFeatureType = enterClass("standalone.jdk.internal.javac.PreviewFeature");
        previewFeatureInternalType = enterSyntheticAnnotation("standalone.jdk.internal.PreviewFeature+Annotation");
        typeDescriptorType = enterClass("java.lang.invoke.TypeDescriptor");
        recordType = enterClass("java.lang.Record");
        switchBootstrapsType = enterClass("java.lang.runtime.SwitchBootstraps");
        constantBootstrapsType = enterClass("java.lang.invoke.ConstantBootstraps");
        valueBasedType = enterClass("standalone.jdk.internal.ValueBased");
        valueBasedInternalType = enterSyntheticAnnotation("standalone.jdk.internal.ValueBased+Annotation");
