...
*/
// Code duplicated in standalone.com.sun.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // standalone.com.sun.tools.javac.jvm.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // standalone.com.sun.tools.javac.jvm.Code.fillExceptionParameterPositions we
