...
import standalone.com.sun.tools.javac.code.Types.SignatureGenerator.InvalidSignatureException;
...
import standalone.com.sun.tools.javac.code.Attribute;
...
import standalone.com.sun.tools.javac.comp.LambdaToMethod.LambdaAnalyzerPreprocessor.*;
import standalone.com.sun.tools.javac.comp.Lower.BasicFreeVarCollector;
...
import static standalone.com.sun.tools.javac.comp.LambdaToMethod.LambdaSymbolKind.*;
            ...
            Symbol translate(final Symbol sym, LambdaSymbolKind skind) {
                ...
                switch (skind) {
                    ...
                    case LOCAL_VAR:
                        ...
                        // Because method standalone.com.sun.tools.javac.jvm.Code.fillExceptionParameterPositions and
                        // standalone.com.sun.tools.javac.jvm.Code.fillLocalVarPosition would use it.
