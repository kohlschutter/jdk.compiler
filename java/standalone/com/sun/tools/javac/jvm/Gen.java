...
import standalone.com.sun.tools.javac.tree.TreeInfo.PosKind;
...
import standalone.com.sun.tools.javac.jvm.Code.*;
import standalone.com.sun.tools.javac.jvm.Items.*;
...
import static standalone.com.sun.tools.javac.jvm.CRTFlags.*;
    ...
    private void handleSwitch(JCTree swtch, JCExpression selector, List<JCCase> cases,
        ...
        if (cases.isEmpty()) {
            ...
            for (int i = 0; i < labels.length; i++) {
                if (l.head.labels.head instanceof JCConstantCaseLabel) {
    ...
    public void visitBinary(JCBinary tree) {
        ...
        Item completeBinop(JCTree lhs, JCTree rhs, OperatorSymbol operator) {
            ...
            if (opcode >= if_icmpeq && opcode <= if_icmple &&
                    (number = rhs.type.constValue()) instanceof Number &&
