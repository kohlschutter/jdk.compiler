...
package standalone.com.sun.tools.javac.api;
...
import standalone.com.sun.source.doctree.EndElementTree;
import standalone.com.sun.source.doctree.StartElementTree;
import standalone.com.sun.source.tree.CatchTree;
import standalone.com.sun.source.tree.CompilationUnitTree;
import standalone.com.sun.source.tree.Scope;
import standalone.com.sun.source.tree.Tree;
import standalone.com.sun.source.util.DocSourcePositions;
import standalone.com.sun.source.util.DocTreePath;
import standalone.com.sun.source.util.DocTreeScanner;
import standalone.com.sun.source.util.DocTrees;
import standalone.com.sun.source.util.JavacTask;
import standalone.com.sun.source.util.SimpleDocTreeVisitor;
import standalone.com.sun.source.util.TreePath;
import standalone.com.sun.tools.javac.code.Flags;
import standalone.com.sun.tools.javac.code.Scope.NamedImportScope;
import standalone.com.sun.tools.javac.code.Scope.StarImportScope;
import standalone.com.sun.tools.javac.code.Scope.WriteableScope;
...
import standalone.com.sun.tools.javac.code.Symbol.ModuleSymbol;
import standalone.com.sun.tools.javac.code.Symbol.PackageSymbol;
import standalone.com.sun.tools.javac.code.Symbol.TypeSymbol;
import standalone.com.sun.tools.javac.code.Symbol.VarSymbol;
import standalone.com.sun.tools.javac.code.Symtab;
import standalone.com.sun.tools.javac.code.Type;
import standalone.com.sun.tools.javac.code.Type.ArrayType;
import standalone.com.sun.tools.javac.code.Type.ClassType;
import standalone.com.sun.tools.javac.code.Type.ErrorType;
import standalone.com.sun.tools.javac.code.Type.UnionClassType;
import standalone.com.sun.tools.javac.code.Types;
import standalone.com.sun.tools.javac.code.Types.TypeRelation;
import standalone.com.sun.tools.javac.comp.Attr;
import standalone.com.sun.tools.javac.comp.AttrContext;
import standalone.com.sun.tools.javac.comp.Enter;
import standalone.com.sun.tools.javac.comp.Env;
import standalone.com.sun.tools.javac.comp.MemberEnter;
import standalone.com.sun.tools.javac.comp.Modules;
import standalone.com.sun.tools.javac.comp.Resolve;
import standalone.com.sun.tools.javac.file.BaseFileManager;
import standalone.com.sun.tools.javac.model.JavacElements;
import standalone.com.sun.tools.javac.parser.DocCommentParser;
import standalone.com.sun.tools.javac.parser.ParserFactory;
import standalone.com.sun.tools.javac.parser.Tokens.Comment;
import standalone.com.sun.tools.javac.parser.Tokens.Comment.CommentStyle;
import standalone.com.sun.tools.javac.processing.JavacProcessingEnvironment;
import standalone.com.sun.tools.javac.resources.CompilerProperties.Errors;
import standalone.com.sun.tools.javac.resources.CompilerProperties.Notes;
import standalone.com.sun.tools.javac.resources.CompilerProperties.Warnings;
import standalone.com.sun.tools.javac.tree.DCTree;
import standalone.com.sun.tools.javac.tree.DCTree.DCBlockTag;
import standalone.com.sun.tools.javac.tree.DCTree.DCDocComment;
import standalone.com.sun.tools.javac.tree.DCTree.DCEndPosTree;
import standalone.com.sun.tools.javac.tree.DCTree.DCErroneous;
import standalone.com.sun.tools.javac.tree.DCTree.DCIdentifier;
import standalone.com.sun.tools.javac.tree.DCTree.DCParam;
import standalone.com.sun.tools.javac.tree.DCTree.DCReference;
import standalone.com.sun.tools.javac.tree.DCTree.DCText;
import standalone.com.sun.tools.javac.tree.DocCommentTable;
import standalone.com.sun.tools.javac.tree.DocTreeMaker;
import standalone.com.sun.tools.javac.tree.EndPosTable;
import standalone.com.sun.tools.javac.tree.JCTree;
import standalone.com.sun.tools.javac.tree.JCTree.JCBlock;
import standalone.com.sun.tools.javac.tree.JCTree.JCCatch;
import standalone.com.sun.tools.javac.tree.JCTree.JCClassDecl;
import standalone.com.sun.tools.javac.tree.JCTree.JCCompilationUnit;
import standalone.com.sun.tools.javac.tree.JCTree.JCExpression;
import standalone.com.sun.tools.javac.tree.JCTree.JCIdent;
import standalone.com.sun.tools.javac.tree.JCTree.JCMethodDecl;
import standalone.com.sun.tools.javac.tree.JCTree.JCVariableDecl;
import standalone.com.sun.tools.javac.tree.TreeCopier;
import standalone.com.sun.tools.javac.tree.TreeInfo;
import standalone.com.sun.tools.javac.tree.TreeMaker;
import standalone.com.sun.tools.javac.util.Abort;
import standalone.com.sun.tools.javac.util.Assert;
...
import standalone.com.sun.tools.javac.util.DiagnosticSource;
import standalone.com.sun.tools.javac.util.JCDiagnostic;
import standalone.com.sun.tools.javac.util.JCDiagnostic.DiagnosticFlag;
...
import standalone.com.sun.tools.javac.util.Position;

import static standalone.com.sun.tools.javac.code.Kinds.Kind.*;
import static standalone.com.sun.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    /** @see standalone.com.sun.tools.javadoc.ClassDocImpl#findField */
    private VarSymbol findField(ClassSymbol tsym, Name fieldName) {
        return searchField(tsym, fieldName, new HashSet<>());
    }

    /** @see standalone.com.sun.tools.javadoc.ClassDocImpl#searchField */
    ...
    /** @see standalone.com.sun.tools.javadoc.ClassDocImpl#findConstructor */
    ...
    /** @see standalone.com.sun.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see standalone.com.sun.tools.javadoc.ClassDocImpl#searchMethod */
    ...
    /** @see standalone.com.sun.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof standalone.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (standalone.com.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof standalone.com.sun.tools.javac.code.Type.ErrorType) {
            return ((standalone.com.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }
        if (errorType instanceof standalone.com.sun.tools.javac.code.Type.ClassType &&
        ...
        return standalone.com.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            standalone.com.sun.source.tree.Tree t,
            standalone.com.sun.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    @Override @DefinedBy(Api.COMPILER_TREE)
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            standalone.com.sun.source.doctree.DocTree t,
            standalone.com.sun.source.doctree.DocCommentTree c,
            standalone.com.sun.source.tree.CompilationUnitTree root) {
