...
package standalone.com.sun.tools.sjavac;
...
import standalone.com.sun.tools.sjavac.comp.PubapiVisitor;
import standalone.com.sun.tools.sjavac.comp.SmartFileManager;
import standalone.com.sun.tools.sjavac.options.Options;
import standalone.com.sun.tools.sjavac.pubapi.PubApi;
...
public class PubApiExtractor {
    ...
    public PubApiExtractor(Options options) {
        JavacTool compiler = standalone.com.sun.tools.javac.api.JavacTool.create();
        fileManager = new SmartFileManager(compiler.getStandardFileManager(null, null, null));
        context = new standalone.com.sun.tools.javac.util.Context();
