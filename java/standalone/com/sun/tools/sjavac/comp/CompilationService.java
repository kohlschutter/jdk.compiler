...
import standalone.com.sun.tools.javac.util.Dependencies;
...
import standalone.com.sun.tools.sjavac.comp.dependencies.NewDependencyCollector;
import standalone.com.sun.tools.sjavac.comp.dependencies.PublicApiCollector;
import standalone.com.sun.tools.sjavac.server.CompilationSubResult;
import standalone.com.sun.tools.sjavac.server.SysInfo;
                ...
                if (explicitJFOs.size() > 0) {
                    ...
                    JavacTaskImpl task =
                            (JavacTaskImpl) compiler.getTask(new PrintWriter(stderrLog),
                                                             ...
                                                             explicitJFOs,
                                                             context);
                    sfm.setSymbolFileEnabled(!standalone.com.sun.tools.javac.util.Options.instance(context).isSet("ignore.symbol.file"));
