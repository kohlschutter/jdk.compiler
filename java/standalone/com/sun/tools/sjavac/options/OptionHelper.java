...
import standalone.com.sun.tools.javac.main.CommandLine;
import standalone.com.sun.tools.sjavac.Transformer;

/**
 * This class is used to decode sjavac options.
 * See standalone.com.sun.tools.sjavac.options.Options for example usage.
 *
    ...
    void traverse(String[] args) {
        ...
        while (argIter.hasNext()) {
            ...
            if (arg.startsWith("-")) {
                ...
                for (standalone.com.sun.tools.javac.main.Option javacOpt : standalone.com.sun.tools.javac.main.Option.values()) {
